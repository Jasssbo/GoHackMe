...
const _naviGreeting = [
  ...
  '',
  '  I am NAVI. I live in the Wired.',
  '  You are holding a protocol — Go, played',
  '  as a conflict between entities across the network.',
...
const Map<String, List<String>> _naviResponses = {
  ...
  '1': [
    ...
    '  The place where consciousness, data, and identity',
    '  dissolve into one.',
